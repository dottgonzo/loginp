...
<div>
    ...
    <div v-if="!$store.state.brand.notAllowRegitration" style="margin-top:30px;text-align:center">
      ...
      <div style="margin-top:30px" v-if="$store.state.mode=='recoversended'">{{$t("remembered")}}? <a href="javascript:void(0)" v-on:click="switchmode($store,'login')">{{$t("login")}} {{$t("here")}}</a></div>
      <div style="margin-top:30px" v-if="$store.state.mode=='recover'">{{$t("remembered")}}? <a href="javascript:void(0)" v-on:click="switchmode($store,'login')">{{$t("login")}} {{$t("here")}}</a></div>
